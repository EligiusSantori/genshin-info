var db = {
	...
	banners: [
		...
		{start: new Date("2022-12-27"), type:"character", characters: ["Raiden", "Ayato", "Rosaria", "Sayu", "Sara"]},
		{start: new Date("2023-01-18"), type:"character", characters: ["Alhaitham", "Xiao", "Yaoyao", "Yun Jin", "Xinyan"]},
		...
		{start: new Date("2023-05-24"), type:"character", characters: ["Yoimiya", "Yae Miko", "Kirara", "Yun Jin", "Chongyun"]},
		{start: new Date("2023-06-13"), type:"character", characters: ["Alhaitham", "Kazuha", "Heizou", "Xiangling", "Yaoyao"]},
		{start: new Date("2023-07-05"), type:"character", characters: ["Eula", "Klee", "Mika", "Razor", "Thoma"]},
		{start: new Date("2023-07-25"), type:"character", characters: ["Kokomi", "Scaramouche", "Faruzan", "Rosaria", "Yanfei"]},
		{start: new Date("2023-08-16"), type:"character", characters: ["Lyney", "Yelan", "Lynette", "Bennett", "Barbara"]},
		{start: new Date("2023-09-05"), type:"character", characters: ["Zhongli", "Tartaglia", "Freminet", "Sayu", "Noelle"]},
		{start: new Date("2023-09-27"), type:"character", characters: ["Neuvillette", "Hu Tao", "Fischl", "Xingqiu", "Diona"]},
		{start: new Date("2023-10-17"), type:"character", characters: ["Wriothesley", "Venti", "Chongyun", "Thoma", "Dori"]},
		//{start: new Date(""), type:"character", characters: ["", "", "", "", ""]},
